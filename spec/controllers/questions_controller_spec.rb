...
let(:my_q) { Question.create!(title: RandomData.random_sentence, body: RandomData.random_paragraph, resolved: true) }
  ...
  describe "GET new" do
      ...
      describe "POST create" do
        ...
        it "increases the number of Questios by 1" do
      ...
      describe "GET edit" do
        ...
        it "assigns question to be updated to @question" do
          ...
          expect(post_instance.id).to eq my_q.id
          expect(post_instance.title).to eq my_q.title
          expect(post_instance.body).to eq my_q.body
          expect(post_instance.resolved).to eq my_q.resolved
        end
      end
